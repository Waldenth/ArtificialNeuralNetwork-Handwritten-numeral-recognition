...
class Painter:
    def __init__(self):
        # 设置了画板窗口的大小与标题
        self.screen = pygame.display.set_mode((1400, 800))#整个界面为1400x800
            ...
            for event in pygame.event.get():
                ...
                # 键盘按键事件
                    ...
                    if event.key == K_ESCAPE:
                        ...
                        string_data=[]
                        string_data=CNN.Identify_Draw_Board(paper)
